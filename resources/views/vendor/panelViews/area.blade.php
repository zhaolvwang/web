			...
			if(dsy.Exists(str)){
				...
				for(i=0;i<ar.length;i++){
					...
					switch (str.length) {
						...
						case 6: 	//county
						case 7: 	//county
							var county = '{{ Input::get("county") }}';
							if (county == '')
								county = '{{ old("county") }}';
							if (county == '')
								county = $("[name='county1']").val();
							if (county == ar[i])
								flag = true;
							break;
					...
					options[length]=new Option(ar[i],ar[i], false, flag);
				}//end for
...
dsy.add("0",["北京市","天津市","上海市","重庆市","河北省","山西省","内蒙古自治区","辽宁省","吉林省","黑龙江省","江苏省","浙江省","安徽省","福建省","江西省","山东省","河南省","湖北省","湖南省","广东省","广西壮族自治区","海南省","四川省","贵州省","云南省","西藏自治区","陕西省","甘肃省","青海省","宁夏回族自治区","新疆维吾尔自治区","香港","澳门","台湾省"]);
...
var opt0 = ["请选择省份","请选择地级市","请选择市、县级市"];//初始值
function _init_area(){  //初始化函数
	if(document.getElementById(s[0]) != null) {
