@extends('layout') @section('content')
	<script type="text/javascript" src="/packages/fore/jquery.banner.js"></script>
	<style>
		.banner{width:720px;overflow:hidden;height:340px;position:relative}
		/*.banList{position:absolute;left:50%;margin-left:-960px;height:470px}*/
		.banList{position:absolute;height:470px}
		.banList li{height:470px;opacity:0;position:absolute;transform:scale(0);transition:transform 0.5s ease 0s, opacity 1.2s ease 0s;z-index:1;}
		.banList li.active{opacity:1;transform:scale(1);z-index:2;}
		.fomW{position:absolute;bottom:4px;left:50%;height:20px;z-index:9;width:1000px;margin-left:-500px}
		.jsNav{text-align:center;}
		.jsNav a{display:inline-block;background:#fff;width:9px;height:9px;border-radius:50%;margin:0 5px;}
...
<div class="idn-top">
	...
	<div class="container-grid clearfix">
		...
		<div class="grid-12">
			...
			{{--<div class="yeehim-banner zz">{!! $data['indexImg']->content !!}</div>--}}
			<div class="banner yeehim-banner zz">
				<ul class="banList">
					<li class="active"><a href="http://sc.chinaz.com/"><img src="/packages/fore/images/banner_01.jpg"></a></li>
					<li class=""><a href="http://sc.chinaz.com/"><img src="/packages/fore/images/banner2.png"></a></li>
					{{--<li class="active"><a href="http://sc.chinaz.com/"><img src="/packages/fore/images/img3.jpg"></a></li>--}}
				</ul>
				<div class="fomW">
					<div class="jsNav">
